...
const timeline = [
  {
    ...
    description:
      'Founded during the global COVID-19 pandemic, our company was initially dedicated to developing solutions to support healthcare providers in managing the surge of COVID-19 patients. Our early efforts were focused on ensuring that clinics had the tools needed to provide care during these challenging times.',
    date: 'July 2020',
    dateTime: '2020-08',
  },
  {
    ...
    description:
      'Recognizing the need for more comprehensive solutions, we expanded our focus to include global clinic management. Our systems began supporting clinics and medical practices around the world, providing them with the tools necessary to handle a wide range of medical and administrative tasks.',
    date: 'Dec 2021',
    dateTime: '2021-12',
  },
  {
    name: 'Launch of Clinic Management System',
    description:
      'In response to growing demand, we launched our flagship Clinic Management System. This all-in-one software integrated various functionalities, including patient care management, scheduling, eBilling, and more, to streamline operations for clinics of all sizes.',
    date: 'Feb 2022',
    dateTime: '2022-02',
  },
  {
    name: 'Leading Innovation in Healthcare Management',
    description:
      'Today, our comprehensive medical practice management system is recognized as a leading solution in the industry. We remain committed to innovating and improving our software to ensure it meets the highest standards of care and operational efficiency. As we move forward, our goal is to continue supporting healthcare providers worldwide with cutting-edge technology and unparalleled service.',
    date: 'July 2024',
    dateTime: '20224-07',
  },
]
  ...
  return (
    <div className="bg-white">
      ...
      <main className="isolate">
        {/* Hero section */}
        <div className="relative isolate -z-10 -mt-20 overflow-hidden bg-gradient-to-b from-indigo-100/20">
          <div
            aria-hidden="true"
              ...
              <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
                ...
                <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
                  <div className="order-first flex w-64 flex-none justify-end self-end lg:w-auto">
                    <img
                      alt=""
                      src="https://th.bing.com/th/id/R.6207881016b676efad438b4b45a1b52f?rik=EijvW%2bLvPYC6CQ&pid=ImgRaw&r=0"
