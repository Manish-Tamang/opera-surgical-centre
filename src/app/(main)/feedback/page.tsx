...
const FeedbackPage = () => {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow rounded-lg p-8 max-w-2xl w-full">
          <h1 className="text-2xl font-bold mb-6">Signin Needed</h1>
          <p className="text-gray-700">You need to be signed in to submit feedback. Please sign in and try again.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-white shadow rounded-lg p-4 sm:p-6 lg:p-8 max-w-lg sm:max-w-xl lg:max-w-2xl w-full">
        ...
        <div className="flex items-start space-x-4 mb-6">
          ...
          <div className="min-w-0 flex-1">
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 w-full"
              >
                Submit Feedback
              </button>
            </form>
